...
public class Startup
{
  ...
  public void ConfigureServices(IServiceCollection services)
  {
    ...
    // ConfigureAuth(services); TODO comment out for today
    services.AddControllers();
    services.AddSwaggerGen(c =>
    {
      c.SwaggerDoc("v1", new OpenApiInfo { Title = "catRoundUp", Version = "v1" });
    });
    // NOTE dependencies established to be used as needed throughout
